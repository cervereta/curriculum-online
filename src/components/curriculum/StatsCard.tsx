...
export const StatsCard: React.FC<StatsCardProps> = ({
  ...
  return (
    ...
    >
      ...
      <div
        className={`absolute bottom-0 left-1/2 transform -translate-x-1/2 w-0 group-hover:w-8 h-0.5 bg-gradient-to-r ${color} transition-all duration-300 rounded-full`}
      />
    </motion.div>
  )
}
