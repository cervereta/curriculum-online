...
export const metadata: Metadata = {
  ...
  title: {
    default:
      'CerveretaDev | Desarrollador Web & Experto en IA - Portfolio España',
    template: '%s | CerveretaDev - Desarrollo Web & IA',
  },
  description:
    'CerveretaDev - Desarrollador Web especializado en Next.js, React, TypeScript e Inteligencia Artificial. 5 años creando soluciones innovadoras con IA, LLMs, automatizaciones y metodología BMAD-METHOD. Portfolio profesional España.',
  keywords: [
    // Marca personal
    'CerveretaDev',
    'Cervereta',
    'Portfolio CerveretaDev',
    // Desarrollo Web
  ...
  openGraph: {
    title:
      'CerveretaDev | Desarrollador Web & Experto en IA - Portfolio España',
    description:
      'Desarrollador Web especializado en Next.js, React e IA. 5 años creando soluciones innovadoras con metodología BMAD-METHOD. Portfolio profesional España.',
  ...
  twitter: {
    ...
    description:
      'Desarrollador especializado en Next.js, React e IA. 5 años creando soluciones innovadoras con metodología BMAD-METHOD.',
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              description:
                'Desarrollador Web especializado en Next.js, React, TypeScript e Inteligencia Artificial',
              url: 'https://cerveretadev.es',
              ...
              hasOccupation: {
                ...
                description:
                  'Especialista en desarrollo web moderno con Next.js, React y tecnologías de IA',
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              url: 'https://cerveretadev.es',
              description:
                'Portfolio profesional de CerveretaDev - Desarrollador Web especializado en Next.js, React e IA',
              author: {
                '@type': 'Person',
                name: 'CerveretaDev',
                '@id': 'https://cerveretadev.es/#person',
