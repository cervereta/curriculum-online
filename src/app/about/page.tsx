  ...
  const projects = [
    {
      ...
      description:
        'WebApp completa para la gestión integral de restaurantes con Next.js y TypeScript',
    ...
    },
    {
      ...
      description:
        'Aplicación especializada para panaderías con ventas al por mayor',
  ...
  const values = [
    {
      ...
      title: 'Código Limpio',
      description:
        'Creo en escribir código mantenible, escalable y bien documentado que perdure en el tiempo.',
    },
    {
      icon: SparklesIcon,
      title: 'Innovación Constante',
      description:
        'Siempre explorando las últimas tecnologías, especialmente en el fascinante mundo de la IA.',
    },
    {
      icon: ComputerDesktopIcon,
      title: 'Soluciones Prácticas',
      description:
        'Me enfoco en resolver problemas reales con aplicaciones que generen valor tangible.',
    },
    {
      icon: GlobeAltIcon,
      title: 'Visión Global',
      description:
        'Desarrollo aplicaciones pensando en escalabilidad y accesibilidad mundial.',
    },
  ]
      ...
      <div className="container mx-auto px-4">
        ...
        >
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
            ...
            combinan tecnología moderna con inteligencia artificial para
            ...
            <div className="grid md:grid-cols-2 gap-8 items-center">
              <div className="space-y-6">
                <p className="text-gray-700 leading-relaxed">
                  Después de toda una vida utilizando la informática como hobby,
                  hace 5 años tomé la decisión que cambiaría mi carrera:
                  aprender lenguajes de programación de forma profesional.
                </p>
                <p className="text-gray-700 leading-relaxed">
                  Lo que comenzó como curiosidad se convirtió en una verdadera
                  pasión. Descubrí que programar no solo era escribir código,
                  sino crear soluciones que pueden impactar positivamente en la
                  vida de las personas y las empresas.
                </p>
                <p className="text-gray-700 leading-relaxed">
                  Hoy, especializado en{' '}
                  <strong className="text-cervereta-blue">
                    Next.js, React y tecnologías de IA
                  </strong>
                  , combino mi experiencia previa con las últimas innovaciones
                  tecnológicas para crear aplicaciones web robustas y
                  eficientes.
                </p>
              </div>
            ...
            <div className="grid lg:grid-cols-2 gap-8">
              ...
              <div className="bg-gradient-to-br from-cervereta-blue to-cervereta-purple rounded-2xl p-8 text-white">
                ...
                <p className="text-white/90 mb-4">
                  La tecnología que más me emociona actualmente es todo lo
                  relacionado con la Inteligencia Artificial. Ver cómo podemos
                  crear sistemas que aprenden, se adaptan y resuelven problemas
                  complejos me parece absolutamente fascinante.
                </p>
                <p className="text-white/90">
                  Desde LLMs hasta automatizaciones inteligentes, cada día
                  descubro nuevas formas de integrar IA en aplicaciones web para
                  crear experiencias más intuitivas y eficientes.
                </p>
              </div>
              ...
              <div className="bg-white rounded-2xl p-8 shadow-lg">
                ...
                <p className="text-gray-600 mb-4">
                  Cuando no estoy programando, me encontrarás disfrutando de la
                  naturaleza. El senderismo es mi forma favorita de desconectar
                  y recargar energías.
                </p>
                <p className="text-gray-600">
                  El estudio de la naturaleza me enseña sobre sistemas
                  complejos, adaptación y eficiencia, conceptos que curiosamente
                  se aplican muy bien al desarrollo de software. La naturaleza
                  es el mejor arquitecto de sistemas.
                </p>
              </div>
            </div>
          </motion.section>
          ...
          <motion.section variants={itemVariants} className="text-center">
            <div className="bg-gradient-to-r from-gray-900 to-gray-800 rounded-2xl p-12 text-white">
              ...
              <p className="text-xl text-gray-300 mb-8 max-w-2xl mx-auto">
                Si tienes una idea, un problema que resolver, o simplemente
